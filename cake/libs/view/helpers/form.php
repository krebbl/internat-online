		...
		switch ($name) {
			...
			case 'month':
				if ($options['monthNames']) {
					$data['01'] = __('Januar', true);
					$data['02'] = __('Februar', true);
					$data['03'] = __('März', true);
					$data['04'] = __('April', true);
					$data['05'] = __('Mai', true);
					$data['06'] = __('Juni', true);
					$data['07'] = __('Juli', true);
					$data['08'] = __('August', true);
					$data['09'] = __('September', true);
					$data['10'] = __('Oktober', true);
					$data['11'] = __('November', true);
					$data['12'] = __('Dezember', true);
				} else {
					for ($m = 1; $m <= 12; $m++) {
